          ...
          <div class="container-fluid">
              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                      <li><a href="#">Logged in as <b><?php echo $_SESSION['name'];echo "&nbsp&nbsp&nbsp"; echo "UID : ".$_SESSION['uid'];?></b></a></li>
          ...
          <div class="row">
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <div class="table-responsive">
                     ...
                     <button type="button" id="subject" class="btn btn-lg" style="background-color:blue;"><a href="createtest.php" style="color:white;">Add questions to bank</a></button>
